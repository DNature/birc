          ...
          <div className="rounded-md bg-white hover:shadow-xl overflow-hidden border-2 hover:border-primary-75 border-transparent">
            ...
            <div className="p-5">
              ...
              <p className="lg:text-md text-gray-75">
                ...
                their bottom lines” culled from Strategy+Business The content of
                most emails relating to the COVID-19 / Coronavirus pandemic have
          ...
          <div className="rounded-md bg-white hover:shadow-xl overflow-hidden border-2 hover:border-primary-75 border-transparent">
            ...
            <div className="p-5">
              ...
              <p className="lg:text-md text-gray-75">
                ...
                Nigeria Precise location and agenda will be sent to participants
                after registration. In light of constantly changing government
                policies, new international standards, currency instability,
                risk and trade duties; potential or new exporters may be
                discouraged and perceive ...
              </p>
              <a href="#" className="block mt-4 text-base text-primary-50">
                Read more <span>&rarr;</span>
              </a>
          ...
          <div className="rounded-md bg-white hover:shadow-xl overflow-hidden border-2 hover:border-primary-75 border-transparent">
            ...
            <div className="p-5">
              ...
              <p className="lg:text-md text-gray-75">
                ...
                kick off the policy execution for the state. At the session, the
              </p>
              <a href="#" className="block mt-4 text-base text-primary-50">
                Read more <span>&rarr;</span>
              </a>
